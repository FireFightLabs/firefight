...
- User-facing copy (UI strings, labels, descriptions, docs prose) uses no em dashes and no unnecessary semicolons — write two sentences, or use a comma/parenthesis. Empty table cells use a plain hyphen, not a dash glyph.
