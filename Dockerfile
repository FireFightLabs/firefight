...
# docker run -d -p 80:80 --env-file .env --name firefight firefight
...
RUN apt-get update -qq && \
    apt-get install --no-install-recommends -y ca-certificates curl libjemalloc2 libvips fonts-dejavu-core postgresql-client nodejs npm && \
