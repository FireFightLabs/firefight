module Slack
  class IncidentTimelineFormatter
    EVENT_STYLE = {
      ...
      IncidentEvent::MARKED_DUPLICATE => { emoji: ":no_entry_sign:", title: "Marked duplicate" },
      IncidentEvent::MERGED_INTO => { emoji: ":twisted_rightwards_arrows:", title: "Merged into incident" },
