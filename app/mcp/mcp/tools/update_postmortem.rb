  ...
  module Tools
    class UpdatePostmortem < Base
      ...
      description "Rewrite the body of a postmortem. Send the whole document as HTML, since this " \
                  ...
                  "get_postmortem first. The markup is sanitised down to what the editor allows, " \
                  "and every version is kept, so a revision is recoverable. If the call requires " \
