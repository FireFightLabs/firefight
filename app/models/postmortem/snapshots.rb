module Postmortem::Snapshots
  ...
  # A caller says which version it read and loses the race rather than the
  # writing. The row is locked so two callers holding the same version cannot both win.
