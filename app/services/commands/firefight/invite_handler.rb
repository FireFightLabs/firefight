  ...
  module Firefight
    class InviteHandler
      def self.execute(command)
        ...
        parsed_targets = parse_targets(command.workspace, command.text)
        ...
        result = IncidentInviteService.new(command.workspace).invite!(incident: command.incident, user_ids: user_ids)
