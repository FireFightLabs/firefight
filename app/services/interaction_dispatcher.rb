class InteractionDispatcher
  VIEW_SUBMISSION_HANDLERS = {
    ...
    Identifiers::CREATE_ACTION_MODAL => Interactions::CreateActionItemHandler,
    Identifiers::CREATE_FOLLOWUP_MODAL => Interactions::CreateActionItemHandler,
  ...
  BLOCK_ACTION_HANDLERS = {
    ...
    Identifiers::UNSUBSCRIBE_INCIDENT => Interactions::UnsubscribeIncidentHandler,
    Identifiers::OPEN_INCIDENT_CHANNEL => Interactions::NoopHandler,
    Identifiers::INCIDENT_HOMEPAGE => Interactions::NoopHandler,
    ...
    Identifiers::ADD_NEW_ACTION => Interactions::OpenActionItemFormHandler,
    Identifiers::ADD_NEW_FOLLOWUP => Interactions::OpenActionItemFormHandler,
    Identifiers::CREATE_ACTION_FROM_REACTION => Interactions::CreateActionItemFromReactionHandler,
    Identifiers::CREATE_FOLLOWUP_FROM_REACTION => Interactions::CreateActionItemFromReactionHandler,
    Identifiers::TIMELINE_PAGE => Interactions::TimelinePageHandler,
    Identifiers::LOAD_MORE_TIMELINE => Interactions::TimelinePageHandler,
  ...
  # A modal submission carries no channel, so it falls back to the incident's.
