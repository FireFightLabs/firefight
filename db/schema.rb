...
ActiveRecord::Schema[8.1].define(version: 2026_09_24_100000) do
  ...
  create_table "ability_grants", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["workspace_id", "principal_type", "principal_id", "action_id"], name: "index_ability_grants_on_principal_action", unique: true, where: "(action_id IS NOT NULL)"
    t.index ["workspace_id", "principal_type", "principal_id", "role_id"], name: "index_ability_grants_on_principal_role", unique: true, where: "(role_id IS NOT NULL)"
  ...
  create_table "conversations", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.uuid "workspace_id", null: false
    t.index ["started_by_type", "started_by_id"], name: "index_conversations_on_started_by_type_and_started_by_id"
  ...
  create_table "incident_subscriptions", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.uuid "workspace_id", null: false
    t.uuid "workspace_membership_id", null: false
    t.index ["incident_id", "workspace_membership_id"], name: "idx_on_incident_id_workspace_membership_id_90f9abf0a6", unique: true
