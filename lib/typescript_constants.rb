...
module TypescriptConstants
  ...
  def self.exports
    [
      ...
      Export.new("OPERATOR_WORKFLOW_STATES", WorkflowRuns::STATES.index_by(&:upcase), nil),
      Export.new("OPERATOR_STEP_STATUSES", WorkflowRuns::STEP_STATUSES.index_by(&:upcase), nil),
      Export.new("OPERATOR_PROCESS_KINDS", Operator::IncidentProcess::KINDS.index_by(&:upcase), nil),
