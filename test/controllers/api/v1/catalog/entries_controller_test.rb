...
class Api::V1::Catalog::EntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "lists entries for a type, excluding deleted" do
    get "/api/v1/catalog/types/team/entries", headers: api_headers
  ...
  test "shows an entry with attributes" do
    get "/api/v1/catalog/entries/cc000001-0000-0000-0000-000000000002", headers: api_headers
    assert_response :success
  ...
  test "create inserts a new entry" do
    assert_difference -> { CatalogEntry.count }, 1 do
      post "/api/v1/catalog/types/team/entries",
  ...
  test "update changes an existing entry" do
    patch "/api/v1/catalog/entries/cc000001-0000-0000-0000-000000000001",
  ...
  test "destroy soft-deletes the entry" do
    delete "/api/v1/catalog/entries/cc000001-0000-0000-0000-000000000001", headers: api_headers
