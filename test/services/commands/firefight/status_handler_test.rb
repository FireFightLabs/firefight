...
class Commands::Firefight::StatusHandlerTest < ActiveSupport::TestCase
  ...
  test "opens incident update modal in incident channel" do
    ...
    result = Commands::Firefight::StatusHandler.execute(
  ...
  test "returns error when workspace not found" do
    ...
    result = Commands::Firefight::StatusHandler.execute(command)
