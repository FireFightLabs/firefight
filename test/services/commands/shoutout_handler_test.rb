...
class Commands::ShoutoutHandlerTest < ActiveSupport::TestCase
  ...
  test "opens shoutout modal in incident channel" do
    stub_open_modal

    result = Commands::ShoutoutHandler.execute(
  ...
  test "returns error when workspace not found" do
    ...
    result = Commands::ShoutoutHandler.execute(command)
