...
class Interactions::CreateFollowupFromReactionHandlerTest < ActiveSupport::TestCase
  ...
  test "opens pre-filled create followup modal" do
    stub_open_modal

    Slack::Client.expects(:open_modal).once.returns({ ok: true, view: { id: "V12345678" } })

    result = Interactions::CreateFollowupFromReactionHandler.execute(build_interaction)
  ...
  test "handles missing incident silently" do
    ...
    interaction = Interaction.new(
      ...
      action_id: Identifiers::CREATE_FOLLOWUP_FROM_REACTION,
      action_value: action_value,
      trigger_id: "12345.trigger"
    )

    result = Interactions::CreateFollowupFromReactionHandler.execute(interaction)
  ...
  def build_interaction
    action_value = {
      ...
      source_message_text: "We should add monitoring",
