module ApiTestHelper
  ...
  # Service keys hold permissions as ability grants, so minting one is create then grant.
  # Returns [key, raw_token] like create_with_token!.
  ...
  # Grants hang off the agent, not the token, so a rotation would not change what it may do.
